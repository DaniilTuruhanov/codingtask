...
public class DefaultCodingtaskService implements CodingtaskService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCodingtaskService.class);
	...
	{
		return DefaultCodingtaskService.class.getResourceAsStream("/codingtask/sap-hybris-platform.png");
	}
