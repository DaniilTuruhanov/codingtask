...
public class Band extends GenericItem
{
	...
	/** Qualifier of the <code>Band.concert</code> attribute **/
	...
	**/
	...
	/**
	* {@link OneToManyHandler} for handling 1:n CONCERT's relation attributes from 'many' side.
	**/
	protected static final OneToManyHandler<Concert> CONCERTHANDLER = new OneToManyHandler<Concert>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Band.concert</code> attribute.
	 * @return the concert
	 */
	public Set<Concert> getConcert(final SessionContext ctx)
	{
		return (Set<Concert>)CONCERTHANDLER.getValues( ctx, this );
	}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>Band.concert</code> attribute. 
	 * @param value the concert
	 */
	public void setConcert(final SessionContext ctx, final Set<Concert> value)
	{
		CONCERTHANDLER.setValues( ctx, this, value );
	}
	 ...
	 * @param value the concert
	 */
	public void setConcert(final Set<Concert> value)
	{
	 ...
	 */
	public void addToConcert(final SessionContext ctx, final Concert value)
	{
		CONCERTHANDLER.addValue( ctx, this, value );
	}
	 ...
	 * @param value the item to add to concert
	 */
	public void addToConcert(final Concert value)
	{
		addToConcert( getSession().getSessionContext(), value );
	}
	 ...
	 */
	public void removeFromConcert(final SessionContext ctx, final Concert value)
	{
		CONCERTHANDLER.removeValue( ctx, this, value );
	}
	 ...
	 * @param value the item to remove from concert
	 */
	public void removeFromConcert(final Concert value)
	{
		removeFromConcert( getSession().getSessionContext(), value );
	}
